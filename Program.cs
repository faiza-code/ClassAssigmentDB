...
namespace OmanClinicSystem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("PLEASE ENTER NUMBER TO CHOIEC YOU SERVISE");
            Console.WriteLine("Clinic Appointment System Menu:");
            ...
            {
                case 1:
                    Console.WriteLine("Enter Your Civial ID Number :");
                ...
                case 6:
                    ...
                    break;
                default:
                    Console.WriteLine("ENTER YOUR CHOIC , 👋 Thank you for using Oman Clinic Appointment System. Goodbye!");
                    break;
            }
        }
    }
